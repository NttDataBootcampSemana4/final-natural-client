package com.bootcampfinal.naturalclient.app.entities;
...
@AllArgsConstructor
@NoArgsConstructor
@Document(collection = "natural-client")
public class NaturalClient {

	private static final Logger LOGGER = LoggerFactory.getLogger(NaturalClient.class);
